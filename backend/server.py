...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:test1234!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:test1234!@localhost")  # No database specified
